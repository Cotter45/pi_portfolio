        ...
        <form action="/api/contact" method="POST" className="w-full space-y-8">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              name="html"
              rows={6}
              className="block p-2.5 w-full text-sm rounded-lg shadow-sm border focus:ring-primary-500 focus:border-primary-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 whitespace-pre-wrap"
